using AXIntegracao.Business.Business;
...
namespace AXIntegracao.Imagem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAxWebConfiguracoesRepository, AxWebConfiguracoesRepository>();
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                s.OperationFilter<SwaggerHeaders>();
            });
        }
